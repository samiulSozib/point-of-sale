...
const Crud = () => {
    ...
    useEffect(() => {
        ...
        setProducts([
            { id:"1",name: 'Customer1', phone_number:"01798779878", email:"samiulcse2018@gmail.com",country:"Bangladesh",address:"Mirpur, Dhaka"  },
            { id:"2",name: 'Customer2', phone_number:"01798779878", email:"samiulcse2018@gmail.com",country:"Bangladesh",address:"Mirpur, Dhaka"  },
            { id:"3",name: 'Customer3', phone_number:"01798779878", email:"samiulcse2018@gmail.com",country:"Bangladesh",address:"Mirpur, Dhaka"  },
    ...
    const actionBodyTemplate = (rowData: Product) => {
        return (
            <>
                <Button title="Edit Customer" icon="pi pi-pencil" rounded severity="success" className="mr-5" onClick={() => editProduct(rowData)} />
                <Button title="Delete Customer" icon="pi pi-trash" rounded severity="warning" onClick={() => confirmDeleteProduct(rowData)} />
            </>
        );
    };
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Mange Customers</h5>
