...
const Crud = () => {
    ...
    const actionBodyTemplate = (rowData: Demo.Product) => {
        return (
            <>
                <Button title="Edit Role-permission" icon="pi pi-pencil" rounded severity="success" className="mr-5" onClick={() => editProduct(rowData)} />
                <Button title="Delete Role-permission" icon="pi pi-trash" rounded severity="warning" onClick={() => confirmDeleteProduct(rowData)} />
            </>
        );
    };
