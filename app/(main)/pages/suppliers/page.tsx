...
const Crud = () => {
    ...
    useEffect(() => {
        ...
        setProducts([
            { id:"1",name: 'Supplier1', phone_number:"01798779878", email:"samiulcse2018@gmail.com",country:"Bangladesh",address:"Mirpur, Dhaka"  },
            { id:"2",name: 'Supplier2', phone_number:"01798779878", email:"samiulcse2018@gmail.com",country:"Bangladesh",address:"Mirpur, Dhaka"  },
            { id:"3",name: 'Supplier3', phone_number:"01798779878", email:"samiulcse2018@gmail.com",country:"Bangladesh",address:"Mirpur, Dhaka"  },
    ...
    const actionBodyTemplate = (rowData: Product) => {
        return (
            <>
                <Button title="Edit Supplier" icon="pi pi-pencil" rounded severity="success" className="mr-5" onClick={() => editProduct(rowData)} />
                <Button title="Delete Supplier" icon="pi pi-trash" rounded severity="warning" onClick={() => confirmDeleteProduct(rowData)} />
            </>
        );
    };
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Mange Suppliers</h5>
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={productDialog} style={{ width: '450px' }} header="Supplier Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                        <div className="field">
