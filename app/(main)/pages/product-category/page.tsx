...
const Crud = () => {
    ...
    const actionBodyTemplate = (rowData: Demo.Product) => {
        return (
            <>
                <Button title="Edit Product" icon="pi pi-pencil" rounded severity="success" className="mr-5" onClick={() => editProduct(rowData)} />
                <Button title="Delete Product" icon="pi pi-trash" rounded severity="warning" onClick={() => confirmDeleteProduct(rowData)} />
            </>
        );
    };
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            <h5 className="m-0">Manage Category</h5>
